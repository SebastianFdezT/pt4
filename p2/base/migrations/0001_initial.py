    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estudiante', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.estudiante')),
                ('preguntas', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base.preguntas')),
            ],
        ),
        migrations.AddField(
